  ...
  $.fn.extend({
    modal: function(settings) {
      ...
      if(s.confimation){
          ...
          var proceed="<a href='" + s.link + "' class='matbtn btn btn-success pull-right' style='margin-left: 15px;'>Proceed</a> <a href='#' class='matbtn btn btn-danger pull-right close-modal'>Cancel</a>";
      }
      ...
      $("#modal-alert").fadeIn();
      $("#modal-alert").html("<div class='title'><h4>"+s.title+"</h4><a href='#' class='close-modal'><i class='zmdi zmdi-close'></i></a></div><p>"+ s.content +"</p>"+proceed);
