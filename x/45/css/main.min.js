 ...
 * - /gh/TransparentLC/WechatMomentScreenshot@master/main.min.js
 *
 ...
 * Original file: /gh/TransparentLC/WechatMomentScreenshot@master/main.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
function loadScript(e){var t=document.createElement("script");t.src=e,document.body.appendChild(t)}function xhrGet(e,t){var n=new XMLHttpRequest;n.open("GET",e),n.onload=function(){t(n.responseText)},n.send()}location.hash="",mdui.confirm('<div class="mdui-typo"><p>使用本工具<strong>不需要强制关注任何公众号或转发任何内容到朋友圈</strong>。如果你发现有公众号存在类似<strong>“关注○○，发送○○，转发○○到朋友圈领取○○”</strong>的行为，请对此类<strong>诱导行为</strong>进行<strong>投诉</strong>。<a href="https://mp.weixin.qq.com/cgi-bin/readtemplate?t=business/faq_operation_tmpl#3dot3_3" target="_blank">什么是诱导行为？</a></p><p>请勿以<strong>“关注○○，发送○○获取工具地址”</strong>或类似方式使用本工具为自己的公众号引流。如果想要推荐的话，请<strong>直接在正文里留下地址或二维码</strong>～</p><p>本工具生成的截图，仅可用于<strong>个人应付各类强制要求转发朋友圈的情形</strong>，请勿<strong>批量生成截图</strong>或将截图用于<strong>造谣诽谤、微商宣传</strong>等非法或令人反感的用途，请勿用于商业用途，<strong>二次部署请勿删除原作者相关信息</strong>。</p><p>当你生成截图时，你应该确定你可以接受向他人发送该截图将会带来的后果和影响，否则请不要使用本工具并离开当前页面。</p><p>本工具谢绝肖战粉丝使用。<a href="https://w.url.cn/s/AC2atup" target="_blank">#我是普通人,我讨厌肖战#</a></p></div>',"在开始使用之前……",(function(){}),(function(){location.href="about:blank"}),{modal:!0,closeOnEsc:!1,history:!1});var inBlacklist=-1!==["www.41661.com","41661.com"].indexOf(location.hostname);inBlacklist&&mdui.alert("你所访问的网站（"+location.hostname+"）由于在转载本工具时抹去了原作者相关信息，已被原作者列入黑名单。点击下方按钮将跳转到原作者自己部署的页面。",(function(){location.href="https://akarin.dev/WechatMomentScreenshot/",document.querySelector(".mdui-container").innerHTML=""}),{modal:!0,closeOnEsc:!1,history:!1}),-1!==navigator.userAgent.toLowerCase().indexOf("micromessenger")&&loadScript("https://cdn.jsdelivr.net/gh/TransparentLC/WechatMomentScreenshot/fuckWechat.min.js"),window.Promise||loadScript("https://cdn.jsdelivr.net/npm/promise-polyfill/dist/polyfill.min.js");var avatarURL=[];xhrGet("https://cdn.jsdelivr.net/gh/TransparentLC/WechatMomentScreenshot/avatarURL.json",(function(e){avatarURL=JSON.parse(e)}));var emoticon=[];xhrGet("https://cdn.jsdelivr.net/gh/TransparentLC/WechatMomentScreenshot/emoticon.json",(function(e){emoticon=JSON.parse(e)}));var config,avatarFile,configDefault={name:"远方源码网",text:"很实用的教程[微笑]\n需要收集五个赞 谢谢大家啦～(　^ω^)",location:"",app:"",height:1920,uiWhite:!1,firstAvatar:!1,appIcon:!1,statusIcon:!0};try{config=JSON.parse(localStorage.getItem("config"))||{}}catch(e){config={}}for(var k in configDefault)void 0===config[k]&&(config[k]=configDefault[k]);function getArticleInfo(){var e=new mdui.Dialog("#request");mdui.prompt("公众号文章链接",(function(t){var n=new XMLHttpRequest;n.open("GET","https://wmsproxy.transparentlc.workers.dev/?url="+encodeURIComponent(t)),n.onreadystatechange=function(){if(4==n.readyState&&200==n.status){var t=JSON.parse(n.responseText);document.getElementById("requestAction").innerText="OK","opening"!=e.getState()&&"opened"!=e.getState()||(void 0!==t&&t.success?(document.getElementById("configArticleTitle").value=t.title,document.getElementById("articleTitle").innerText=t.title,document.getElementById("articleIcon").style.backgroundImage='url("'+t.cover+'")',document.getElementById("requestResult").innerText="获取成功！(ゝ∀･)",document.getElementById("requestResultContent").innerHTML="标题："+t.title+'<br>封面：<a target="_blank" href="'+t.cover+'">点此查看</a>'):(document.getElementById("requestResult").innerText="获取失败！( ´_っ`)",document.getElementById("requestResultContent").innerHTML="输入的链接是否为微信公众号文章？<br>（链接通常以 <code>https://mp.weixin.qq.com/</code> 作为开头）"))}else document.getElementById("requestResult").innerText="获取失败！( ´_っ`)",document.getElementById("requestResultContent").innerHTML="无法连接到服务器。";e.handleUpdate()},n.send(),document.getElementById("requestResult").innerText="",document.getElementById("requestAction").innerText="CANCEL",document.getElementById("requestResultContent").innerHTML='<div class="mdui-valign"><div class="mdui-spinner"></div><span class="mdui-m-l-2">获取中…… (oﾟωﾟo)</span></div>',mdui.updateSpinners(),e.open()}),(function(){}))}function clearMultiImage(){for(var e=1;e<=9;e++)document.getElementById("image"+e).style.backgroundImage=""}function getTimeString(e,t){var n=new Date(e.getTime()-60*e.getTimezoneOffset()*1e3-(e.getTime()-60*e.getTimezoneOffset()*1e3)%864e5),o=new Date(t.getTime()-60*t.getTimezoneOffset()*1e3-(t.getTime()-60*t.getTimezoneOffset()*1e3)%864e5);return n.getTime()==o.getTime()?(t.getHours()<10?"0"+t.getHours():t.getHours())+":"+(t.getMinutes()<10?"0"+t.getMinutes():t.getMinutes()):n.getTime()-o.getTime()==864e5?"昨天 "+(t.getHours()<10?"0"+t.getHours():t.getHours())+":"+(t.getMinutes()<10?"0"+t.getMinutes():t.getMinutes()):t.getFullYear()+"年"+(t.getMonth()+1)+"月"+t.getDate()+"日 "+(t.getHours()<10?"0"+t.getHours():t.getHours())+":"+(t.getMinutes()<10?"0"+t.getMinutes():t.getMinutes())}function copyGitLink(){document.getElementById("gitLink").style.display="block";var e=document.createRange();e.selectNodeContents(document.getElementById("gitLink"));var t=document.getSelection();t.removeAllRanges(),t.addRange(e),document.execCommand("Copy"),t.removeAllRanges(),mdui.snackbar({message:"已复制到剪贴板～( っ*'ω'*c)"}),document.getElementById("gitLink").style.display="none"}document.getElementById("configName").value=config.name,document.getElementById("configText").value=config.text,document.getElementById("configLocation").value=config.location,document.getElementById("configApp").value=config.app,document.getElementById("configHeight").value=config.height,document.getElementById("configUIWhite").checked=config.uiWhite,document.getElementById("configFirstAvatar").checked=config.firstAvatar,document.getElementById("configTopBarAppIcons").checked=config.appIcon,document.getElementById("configTopBarStatusIcons").checked=config.statusIcon,document.getElementById("avatar").style.backgroundImage="url("+(localStorage.getItem("avatar")||"https://ae01.alicdn.com/kf/HTB1yE4fMmzqK1RjSZFp761kSXXal.png")+")";var commentList=[];function addComment(e,t,n,o,c){commentList.push({avatar:e,name:t,content:n,date:o,reply:c});var m=document.createElement("tr");m.innerHTML="<th>"+commentList.length+"</th><th>"+t+(c?"（回复"+c+"）":"")+"</th><th>"+n+"</th><th>"+o.toLocaleString()+"</th>",document.getElementById("configCommentList").append(m)}function removeComment(){commentList.length&&(commentList.pop(),document.getElementById("configCommentList").removeChild(document.getElementById("configCommentList").lastChild))}function emoticonReplace(e){e=e.replace(/\r?\n/g,"<br>");for(var t=0;t<emoticon.length;t++)e=e.replace(new RegExp(emoticon[t].name,"g"),'<img class="emoticon" src="'+emoticon[t].URL+'">');return e}function randomName(){var e=["王","李","张","刘","陈","杨","黄","吴","赵","周","徐","孙","马","朱","胡","林","郭","何","高","罗","郑","梁","谢","宋","唐","许","邓","冯","韩","曹","曾","彭","萧","蔡","潘","田","董","袁","于","余","叶","蒋","杜","苏","魏","程","吕","丁","沈","任","姚","卢","傅","钟","姜","崔","谭","廖","范","汪","陆","金","石","戴","贾","韦","夏","邱","方","侯","邹","熊","孟","秦","白","江","阎","薛","尹","段","雷","黎","史","龙","陶","贺","顾","毛","郝","龚","邵","万","钱","严","赖","覃","洪","武","莫","孔"],t=["绍齐","博文","梓晨","胤祥","瑞霖","明哲","天翊","凯瑞","健雄","耀杰","潇然","子涵","越彬","钰轩","智辉","致远","俊驰","雨泽","烨磊","晟睿","文昊","修洁","黎昕","远航","旭尧","鸿涛","伟祺","荣轩","越泽","浩宇","瑾瑜","皓轩","擎苍","擎宇","志泽","子轩","睿渊","弘文","哲瀚","雨泽","楷瑞","建辉","晋鹏","天磊","绍辉","泽洋","鑫磊","鹏煊","昊强","伟宸","博超","君浩","子骞","鹏涛","炎彬","鹤轩","越彬","风华","靖琪","明辉","伟诚","明轩","健柏","修杰","志泽","弘文","峻熙","嘉懿","煜城","懿轩","烨伟","苑博","伟泽","熠彤","鸿煊","博涛","烨霖","烨华","煜祺","智宸","正豪","昊然","明杰","立诚","立轩","立辉","峻熙","弘文","熠彤","鸿煊","烨霖","哲瀚","鑫鹏","昊天","思聪","展鹏","笑愚","志强","炫明","雪松","思源","智渊","思淼","晓啸","天宇","浩然","文轩","鹭洋","振家","乐驹","晓博","文博","昊焱","立果","金鑫","锦程","嘉熙","鹏飞","子默","思远","浩轩","语堂","聪健","明","文","果","思","鹏","驰","涛","琪","浩","航","彬"];return e[Math.floor(Math.random()*e.length)]+t[Math.floor(Math.random()*t.length)]}function addPlayIcon(){Promise.all([new Promise((e=>{var t=new Image;t.crossOrigin="anonymous",t.onload=function(){e(t)},t.src=document.getElementById("image").src})),new Promise((e=>{var t=new Image;t.onload=function(){e(t)},t.src="data:image/png;base64,"}))]).then((function(e){var t=e[0],n=e[1],o=document.createElement("canvas");o.width=t.width,o.height=t.height;var c=o.getContext("2d");c.drawImage(t,0,0),c.drawImage(n,t.width/2-o.width/4/2,t.height/2-o.width/4/2,o.width/4,o.width/4),o.toBlob((function(e){URL.revokeObjectURL(document.getElementById("image").src),document.getElementById("image").src=URL.createObjectURL(e),console.log(URL.createObjectURL(e)),mdui.snackbar("已添加视频播放图标")}))}))}document.getElementById("configTypeText").onclick=function(){document.getElementById("configWebsite").style.display="none",document.getElementById("configSingleImage").style.display="none",document.getElementById("configMultiImage").style.display="none",document.getElementById("article").style.display="none",document.getElementById("singleImage").style.display="none",document.getElementById("multiImage").style.display="none"},document.getElementById("configTypeWebsite").onclick=function(){document.getElementById("configWebsite").style.display="block",document.getElementById("configSingleImage").style.display="none",document.getElementById("configMultiImage").style.display="none",document.getElementById("article").style.display="flex",document.getElementById("singleImage").style.display="none",document.getElementById("multiImage").style.display="none"},document.getElementById("configTypeSingleImage").onclick=function(){document.getElementById("configWebsite").style.display="none",document.getElementById("configSingleImage").style.display="block",document.getElementById("configMultiImage").style.display="none",document.getElementById("article").style.display="none",document.getElementById("singleImage").style.display="block",document.getElementById("multiImage").style.display="none"},document.getElementById("configTypeMultiImage").onclick=function(){document.getElementById("configWebsite").style.display="none",document.getElementById("configSingleImage").style.display="none",document.getElementById("configMultiImage").style.display="block",document.getElementById("article").style.display="none",document.getElementById("singleImage").style.display="none",document.getElementById("multiImage").style.display="block"};var date=new Date;document.getElementById("configScreenshotDate").valueAsDate=date,document.getElementById("configScreenshotTimeHour").value=date.getHours(),document.getElementById("configScreenshotTimeMinute").value=date.getMinutes(),document.getElementById("configPostDate").valueAsDate=date,document.getElementById("configPostTimeHour").value=date.getHours(),document.getElementById("configPostTimeMinute").value=date.getMinutes(),document.getElementById("configCommentDate").valueAsDate=date,document.getElementById("configCommentTimeHour").value=date.getHours(),document.getElementById("configCommentTimeMinute").value=date.getMinutes(),document.getElementById("configLike").value=Math.floor(20*Math.random()),document.getElementById("configPostTimeHour").addEventListener("input",(function(){document.getElementById("configPostTimeHour").value>23?document.getElementById("configPostTimeHour").value=23:document.getElementById("configPostTimeHour").value<0&&(document.getElementById("configPostTimeHour").value=0)})),document.getElementById("configPostTimeMinute").addEventListener("input",(function(){document.getElementById("configPostTimeMinute").value>59?document.getElementById("configPostTimeMinute").value=59:document.getElementById("configPostTimeMinute").value<0&&(document.getElementById("configPostTimeMinute").value=0)})),document.getElementById("configScreenshotTimeHour").addEventListener("input",(function(){document.getElementById("configScreenshotTimeHour").value>23?document.getElementById("configScreenshotTimeHour").value=23:document.getElementById("configScreenshotTimeHour").value<0&&(document.getElementById("configScreenshotTimeHour").value=0)})),document.getElementById("configScreenshotTimeMinute").addEventListener("input",(function(){document.getElementById("configScreenshotTimeMinute").value>59?document.getElementById("configScreenshotTimeMinute").value=59:document.getElementById("configScreenshotTimeMinute").value<0&&(document.getElementById("configScreenshotTimeMinute").value=0)})),document.getElementById("configCommentTimeHour").addEventListener("input",(function(){document.getElementById("configCommentTimeHour").value>23?document.getElementById("configCommentTimeHour").value=23:document.getElementById("configCommentTimeHour").value<0&&(document.getElementById("configCommentTimeHour").value=0)})),document.getElementById("configCommentTimeMinute").addEventListener("input",(function(){document.getElementById("configCommentTimeMinute").value>59?document.getElementById("configCommentTimeMinute").value=59:document.getElementById("configCommentTimeMinute").value<0&&(document.getElementById("configCommentTimeMinute").value=0)})),document.getElementById("configLike").addEventListener("input",(function(){document.getElementById("configLike").value<0&&(document.getElementById("configLike").value=0)})),document.getElementById("configAvatar").addEventListener("change",(function(){avatarFile=this.files[0],document.getElementById("avatar").style.backgroundImage='url("'+URL.createObjectURL(avatarFile)+'")'})),document.getElementById("configArticleIcon").addEventListener("change",(function(){document.getElementById("articleIcon").style.backgroundImage='url("'+URL.createObjectURL(this.files[0])+'")'})),document.getElementById("configSetSingleImage").addEventListener("change",(function(){document.getElementById("image").src=URL.createObjectURL(this.files[0])}));for(var i=1;i<=9;i++)!function(e){document.getElementById("configSetMultiImage"+e).addEventListener("change",(function(){document.getElementById("image"+e).style.backgroundImage='url("'+URL.createObjectURL(this.files[0])+'")'}))}(i);document.getElementById("generate").addEventListener("click",(function(){var e=document.getElementById("configUIWhite").checked;if(e?(document.getElementById("fakeWechatMoment").classList.add("whiteUI"),document.querySelector("#header > img").src="mdicons/black_icons/back.svg",document.querySelector(".content > img").src="mdicons/black_icons/comment.svg",document.querySelector("#footer > img").src="mdicons/black_icons/emoticon.svg"):(document.getElementById("fakeWechatMoment").classList.remove("whiteUI"),document.querySelector("#header > img").src="mdicons/white_icons/back.svg",document.querySelector(".content > img").src="mdicons/white_icons/comment.svg",document.querySelector("#footer > img").src="mdicons/white_icons/emoticon.svg"),document.getElementById("name").innerText=document.getElementById("configName").value,document.getElementById("text").innerText=document.getElementById("configText").value,document.getElementById("articleTitle").innerText=document.getElementById("configArticleTitle").value,""==document.getElementById("configLocation").value?document.getElementById("location").style.display="none":(document.getElementById("location").style.display="inline",document.getElementById("location").innerText=document.getElementById("configLocation").value),document.getElementById("text").innerHTML=emoticonReplace(document.getElementById("text").innerText.replace(/((?:^|\s)#\S+(?:$|\s))/gm,'<span style="color:#576b95">$1</span>').replace(/(https?:\/\/(?:www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b(?:[-a-zA-Z0-9()@:%_\+.~#?&//=]*))/g,'<span style="color:#576b95">$1</span>')),console.log(document.getElementById("text").innerHTML),document.getElementById("configTypeMultiImage").checked){for(var t=1;t<=9;t++)document.getElementById("image"+t).style.display="inline-block";var n=0;for(n=9;n>=1&&""==document.getElementById("image"+n).style.backgroundImage;n--);4==n&&(document.getElementById("image5").style.backgroundImage=document.getElementById("image4").style.backgroundImage,document.getElementById("image4").style.backgroundImage=document.getElementById("image3").style.backgroundImage,document.getElementById("image3").style.backgroundImage="",n=5);for(t=n+1;t<=9;t++)document.getElementById("image"+t).style.display="none"}var o=[4,4,4,4,4,3,3,3,3,2,2,2,2,1,1,1,0],c=[20,30,50,60,80,90,"full"];document.getElementById("configTopBarStatusIcons").checked?(document.getElementById("topBarIconWifi").src="mdicons/"+(e?"black_icons":"white_icons")+"/ic_signal_wifi_"+o[Math.floor(Math.random()*o.length)]+"_bar_48px.svg",document.getElementById("topBarIconSignal").src="mdicons/"+(e?"black_icons":"white_icons")+"/ic_signal_cellular_"+o[Math.floor(Math.random()*[4,4,4,4,4,3,3,3,3,3,2,2,2,2,1,1,0].length)]+"_bar_48px.svg",document.getElementById("topBarIconBattery").src="mdicons/"+(e?"black_icons":"white_icons")+"/ic_battery_"+(Math.random()>.75?"charging_":"")+c[Math.floor(Math.random()*c.length)]+"_48px.svg"):(document.getElementById("topBarIconWifi").src="mdicons/"+(e?"black_icons":"white_icons")+"/ic_signal_wifi_4_bar_48px.svg",document.getElementById("topBarIconSignal").src="mdicons/"+(e?"black_icons":"white_icons")+"/ic_signal_cellular_4_bar_48px.svg",document.getElementById("topBarIconBattery").src="mdicons/"+(e?"black_icons":"white_icons")+"/ic_battery_full_48px.svg");var m=[["qq",.5],["wechat",.5],["cloudmusic",.25],["coolapk",.15],["tieba",.15],["acfun",.15]];if(m.sort((function(){return Math.random()>.5?1:-1})),document.getElementById("topBarAppIcons").innerHTML="",document.getElementById("configTopBarAppIcons").checked)for(t=0;t<m.length;t++)Math.random()<m[t][1]&&(document.getElementById("topBarAppIcons").innerHTML+='<img class="topBarIcon" src="mdicons/'+(e?"black_icons":"white_icons")+"/app_"+m[t][0]+'.svg">');var i=document.getElementById("configPostDate").valueAsDate;i.setHours(document.getElementById("configPostTimeHour").value),i.setMinutes(document.getElementById("configPostTimeMinute").value);var a=document.getElementById("configScreenshotDate").valueAsDate;a.setHours(document.getElementById("configScreenshotTimeHour").value),a.setMinutes(document.getElementById("configScreenshotTimeMinute").value),document.getElementById("time").innerHTML=getTimeString(a,i),document.getElementById("topBarTime").innerText=(document.getElementById("configScreenshotTimeHour").value<10?"0"+document.getElementById("configScreenshotTimeHour").value:document.getElementById("configScreenshotTimeHour").value)+":"+(document.getElementById("configScreenshotTimeMinute").value<10?"0"+document.getElementById("configScreenshotTimeMinute").value:document.getElementById("configScreenshotTimeMinute").value),document.getElementById("configApp")&&(document.getElementById("configApp").value.match(/视频号 *· *(.+)/g)?document.getElementById("time").innerHTML+=' <span style="color:#576b95">视频号 · '+/视频号 *· *(.+)/g.exec(document.getElementById("configApp").value)[1]+"</span>":document.getElementById("time").innerHTML+=" "+document.getElementById("configApp").value);var d,l=avatarURL.concat();document.getElementById("likeAvatarList").innerHTML="";for(t=0;t<document.getElementById("configLike").value;t++){if(0===t&&document.getElementById("configFirstAvatar").checked)d=document.getElementById("avatar").style.backgroundImage.replace(/url\("(.+?)"\)/g,"$1");else{l.length<=0&&(l=avatarURL.concat());var g=Math.floor(Math.random()*l.length);d=l[g],l.splice(g,1)}var u=document.createElement("div");u.setAttribute("class","likeAvatar squareImage"),u.setAttribute("style",'background-image:url("'+d+'")'),document.getElementById("likeAvatarList").appendChild(u)}if(document.getElementById("commentList").innerHTML="",document.getElementById("configShowComment").checked&&commentList.length){document.getElementById("comment").style.display="block";for(t=0;t<commentList.length;t++){var s=commentList[t];document.getElementById("commentList").innerHTML+='<div class="commentItem"><div class="commentAvatar squareImage" style="background-image: url('+s.avatar+');"></div><div class="content"><span class="commentName">'+s.name+'</span><span class="commentTime">'+getTimeString(a,s.date)+'</span><div class="commentText">'+(s.reply?'回复<span style="color:#576b95">'+s.reply+"</span>: ":"")+emoticonReplace(s.content)+"</div></div></div>"}}else document.getElementById("comment").style.display="none";var r=Number(document.getElementById("configHeight").value);document.getElementById("fakeWechatMoment").style.display="block",document.getElementById("fakeWechatMoment").style.width="1080px",document.getElementById("fakeWechatMoment").style.height="",document.getElementById("fakeWechatMoment").style.height=(window.getComputedStyle(document.getElementById("fakeWechatMoment")).height.replace("px","")>r?window.getComputedStyle(document.getElementById("fakeWechatMoment")).height.replace("px",""):r)+"px",document.getElementById("configLike").value<=0?(document.getElementById("triangle").style.display="none",document.getElementById("like").style.display="none"):(document.getElementById("triangle").style.display="block",document.getElementById("like").style.display="block");var y=Number(window.getComputedStyle(document.getElementById("topBar")).height.replace("px",""))+Number(window.getComputedStyle(document.getElementById("header")).height.replace("px",""))+Number(window.getComputedStyle(document.getElementById("main")).height.replace("px",""));document.getElementById("footer").style.bottom=(y<r-Number(window.getComputedStyle(document.getElementById("footer")).height.replace("px",""))?-r+Number(window.getComputedStyle(document.getElementById("footer")).height.replace("px",""))+y:0)+"px",document.getElementById("generate").setAttribute("disabled",""),document.getElementById("generate").innerText="生成中...",(inBlacklist?Promise.reject("你所访问的网站（"+location.hostname+"）由于在转载本工具时抹去了原作者相关信息，已被原作者列入黑名单，无法生成截图。"):html2canvas(document.getElementById("fakeWechatMoment"),{useCORS:!0,scale:1})).then((function(e){var t=e.toDataURL();document.getElementById("generated").src=t,document.getElementById("save").setAttribute("href",t),document.getElementById("save").setAttribute("download",+new Date+".png"),new mdui.Dialog(document.getElementById("generatedPopup")).open();var n={name:document.getElementById("configName").value,text:document.getElementById("configText").value,location:document.getElementById("configLocation").value,app:document.getElementById("configApp").value,height:parseInt(document.getElementById("configHeight").value),uiWhite:document.getElementById("configUIWhite").checked,appIcon:document.getElementById("configTopBarAppIcons").checked,statusIcon:document.getElementById("configTopBarStatusIcons").checked};if(localStorage.setItem("config",JSON.stringify(n)),avatarFile){var o=new FileReader;o.readAsDataURL(avatarFile),o.onload=function(){localStorage.setItem("avatar",this.result)}}})).catch((function(e){mdui.alert('<div class="mdui-typo"><p>'+e+"</p><pre>"+e.stack+'</pre><p>你可以通过 <a href="https://github.com/TransparentLC/WechatMomentScreenshot/issues" target="_blank">Issue</a> 向作者反馈 BUG～</p></div>',"生成失败")})).finally((function(){document.getElementById("generate").removeAttribute("disabled"),document.getElementById("generate").innerText="生成"}))}));
//# sourceMappingURL=/sm/a7c6db1fa97d487a7cd9562075665151f365b7934907045bbd0f3a5db44d473b.map